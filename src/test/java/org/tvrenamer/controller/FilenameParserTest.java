 ...
 *
 * Multi-episode note:
 * TVRenamer supports some "single file contains multiple episodes" patterns
 * (e.g., S01E04E05, S02E04-E06, S02E04-06). When parsed, the placement should
 * use the lowest episode (A), and the multi-episode span (A..B) is stored on
 * the FileEpisode for later "(A-B)" title suffix handling.
 */
public class FilenameParserTest {
    ...
    public static void setupValuesMultiEpisodeExplicitList() {
        ...
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename("The.Hulk.S04E01E07.Silver.Linings.mkv")
                .filenameShow("The.Hulk")
                .seasonNumString("04")
                .episodeNumString("01")
                .build()
        );
        ...
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename("Show.Name.S01E04E05.mkv")
                .filenameShow("Show.Name")
                .seasonNumString("01")
                .episodeNumString("04")
                .build()
        );
        ...
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename("Show.Name.S01E04E05E06.mkv")
                .filenameShow("Show.Name")
                .seasonNumString("01")
                .episodeNumString("04")
                .build()
    ...
    public static void setupValuesMultiEpisodeRanges() {
        ...
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename("Show.Name.S02E04-E06.mkv")
                .filenameShow("Show.Name")
                .seasonNumString("02")
                .episodeNumString("04")
                .build()
        ...
        // Short range form: S02E04-06 => select E04
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename("Show.Name.S02E04-06.mkv")
                .filenameShow("Show.Name")
                .seasonNumString("02")
                .episodeNumString("04")
                .build()
    ...
    public static void setupValuesLongThreeDigitSeason() {
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename(
                    "House Hunters International " + "Season 103 Episode 2.mkv"
                )
                .filenameShow("House Hunters International")
                .seasonNumString("103")
                .episodeNumString("02")
    ...
    public static void setupValuesDotThreeDigitSeason() {
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename("House.Hunters.International." + "s103.e02.mkv")
                .filenameShow("House.Hunters.International")
                .seasonNumString("103")
                .episodeNumString("02")
                .build()
    ...
    public static void setupValues02a() {
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename(
                    "MyShows/drama/widescreen/24/8x21.720p.hdtv.x264-immerse.mkv"
                )
                .filenameShow("24")
                .seasonNumString("8")
                .episodeNumString("21")
    ...
    public static void setupValues25() {
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename(
                    "House.Of.Cards.2013.S01E06.HDTV.x264-EVOLVE.mp4"
                )
    ...
    public static void setupValues36() {
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename(
                    "The.Walking.Dead.S04E16.PROPER.HDTV.x264-2HD.mp4"
                )
    ...
    public static void setupValues38() {
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename(
                    "Witches.of.East.End.S01E01.PROPER.HDTV.x264-2HD.mp4"
                )
    ...
    public static void setupValues55() {
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename(
                    "Strike.Back.S01E01.Mini.720p.HDTV.DD5.1.x264.mkv"
                )
    ...
    public static void setupValues61() {
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename(
                    "The.Big.Bang.Theory.S10E04.720p.HDTV.X264-DIMENSION[ettv].mkv"
                )
                .filenameShow("The.Big.Bang.Theory")
                .seasonNumString("10")
                .episodeNumString("4")
    ...
    public static void setupValues63() {
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename(
                    "Marvels.Agents.of.S.H.I.E.L.D.S04E03.1080p.HDTV.x264-KILLERS[ettv].mkv"
                )
                .filenameShow("Marvels.Agents.of.S.H.I.E.L.D")
                .seasonNumString("4")
                .episodeNumString("3")
    ...
    public static void setupValues66() {
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename(
                    "Channel.Zero.S01E01.480p.HDTV.X264-DIMENSION[ettv].mkv"
                )
    ...
    public static void setupValues72() {
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename(
                    "Quintuplets/Season1/versions/S01E02.Quintagious~9.avi"
                )
                .filenameShow("Quintuplets")
                .seasonNumString("01")
                .episodeNumString("02")
    ...
    public static void setupValues73() {
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename(
                    "Quintuplets/Season01/versions/S01E02.Quintagious~4.avi"
                )
                .filenameShow("Quintuplets")
                .seasonNumString("01")
                .episodeNumString("02")
    ...
    public static void setupValues77() {
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename(
                    "Videos/TVShows/Fullscreen/LiveAction/Quintuplets/" +
    ...
    public static void setupValues78() {
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename(
                    "Quintuplets/Quintuplets.Season01/s01/" +
    ...
    public static void setupValues81() {
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename(
                    "The Big Bang Theory - S04E09 - The 2003 Approximation.mkv"
                )
                .filenameShow("The Big Bang Theory")
                .seasonNumString("04")
                .episodeNumString("09")
    ...
    public static void setupValues82() {
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename(
                    "The Big Bang Theory - S04E09 - The 2003 Approximation - 2015-10-12.mkv"
                )
                .filenameShow("The Big Bang Theory")
                .seasonNumString("04")
                .episodeNumString("09")
    ...
    public static void setupValues85() {
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename(
                    "Archer (2009)/Archer (2009) S01E02 Training Day 2010.01.14.mp4"
                )
                .filenameShow("Archer (2009)")
                .seasonNumString("01")
                .episodeNumString("02")
    ...
    public static void setupValues86() {
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename(
                    "Archer (2009)/S01E02 Training Day 2010.01.14.mp4"
                )
                .filenameShow("Archer (2009)")
                .seasonNumString("01")
                .episodeNumString("02")
    ...
    public static void setupValues92() {
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename(
                    "Cheers - S09E21 - It's a Wonderful Wife - 1991.02.28.avi"
                )
                .filenameShow("Cheers")
                .seasonNumString("09")
                .episodeNumString("21")
    ...
    public static void setupValues94() {
        values.add(
            new EpisodeTestData.Builder()
                .inputFilename(
                    "Cheers.S09E21.Its.A.Wonderful.Wife.1991.02.28.avi"
                )
                .filenameShow("Cheers")
                .seasonNumString("09")
                .episodeNumString("21")
